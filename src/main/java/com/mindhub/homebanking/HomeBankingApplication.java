...
public class HomeBankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository, TransactionRepository transactionRepository, LoanRepository loanRepository, ClientLoanRepository clientLoanRepository, CardRepository cardRepository) {
		return (args) -> {
			...
			Account account4 = new Account("VIN004",LocalDateTime.now(),375000.0, true, AccountType.CURRENT);
			client1.addAccount(account1);
			client1.addAccount(account2);
			client2.addAccount(account3);
			client2.addAccount(account4);

			Transaction transaction1 = new Transaction(TransactionType.DEBIT, 250.20, "Debito Tarjeta credito", LocalDateTime.now(),6250.40);
			...
			Loan loanHipotecario = new Loan ("Hipotecario",550000, Arrays.asList(12,24,36,48,60),5.0 );
			Loan loanPersonal = new Loan ("Personal",200000, Arrays.asList(6,12,24), 8.0);
			Loan loanAutomotriz = new Loan ("Automotriz",300000, Arrays.asList(6,12,24,36), 6.5);

			ClientLoan loan1 = new ClientLoan(62g0000,60,"Hipotecario" );
			ClientLoan loan2 = new ClientLoan(420000,12,"Personal" );
			ClientLoan loan3 = new ClientLoan(280000,24,"Personal");
			ClientLoan loan4 = new ClientLoan(320000,36, "Automotriz");
